...
public class WeatherService {
    ...
    public WeatherResponse getData(String city) {
        ...
        weatherResponse.setHumidity(String.valueOf(response.getCurrent().getHumidity()));
        weatherResponse.setWindSpeed(String.valueOf(response.getCurrent().getWind_kph()));
        weatherResponse.setPressure(String.valueOf(response.getCurrent().getPressure_mb()));
        weatherResponse.setFeelsLike(String.valueOf(response.getCurrent().getFeelslike_c()));
